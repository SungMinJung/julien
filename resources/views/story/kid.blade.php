...
<div id="popup">
    ...
    <div class="col-sm-9 border-left" style="margin-top:5%; padding-left: 5%;">
        <img src="http://julienwaffle.com/wp-content/uploads/2016/05/up3.png" style="width:100%; padding-top:100px;">
        <div class="row">
            <div class="col-sm-12" >
                <div id="subject">
                <p><strong> 줄리앙 와플의 홍보대사 !</strong></p>
                <p><strong> 꼬마 줄리앙</strong></p>
                </div>
