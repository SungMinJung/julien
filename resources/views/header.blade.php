...
<head>
    ...
    <title>jullienwaffle</title>
<body>
<div class="navbar navbar-fixed-top">
   <div class="container">
       <div class="navbar-header">
           <a class="navbar-brand" href="#">
           <img src="http://julienwaffle.com/wp-content/uploads/2017/02/logo_animated-1.gif" width="266.81px" height="88px"></a>
       </div>
           ...
           <ul class="nav navbar-nav pull-right">
              <li class="dropdown">
                   ...
                   <ul class="dropdown-menu menu-size">
                       ...
                       <li><a href="#">꼬마 줄리앙</a></li>
                       <li><a href="#">커피&와플</a></li>
                       <li><a href="#">킴스 와플</a></li>
